...
**Run id:** `replay_lookup_member_and_get_savings_balance_20260915T040031_b5c2af`  
**Goal:** Look up a member by ID and return their current savings balance.  
**Target:** 127.0.0.1_5050 (web)  
**Started:** 2026-09-15T04:00:31.169800+00:00 · **Duration:** 0.77s · **Outcome:** ✅ Success
...
Typed {{member_id}} into textbox "Search by Member ID, Name, or partial SSN", entered '10006'.
Locator: primary · Verified: ✓ · URL: `http://127.0.0.1:5050/members/search`
...
Clicked link "10001".
Locator: primary · Verified: ✓ · URL: `http://127.0.0.1:5050/members/10006`

### 9. extract: s4
![screenshot](screenshots/step9.png)
Read '$8,714.97' from cell "$8,714.97", read '$11,307.23'.
Locator: primary · Verified: ✓ · URL: `http://127.0.0.1:5050/members/10006`
